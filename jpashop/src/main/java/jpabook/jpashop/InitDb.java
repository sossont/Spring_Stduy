...
public class InitDb {
    ...
    static class InitService {
        ...
        public void dbInit1() {
            Address address = new Address("서울", "1", "1111");
            ...
            Book book2 = createBook("JPA2", 40000, 300);
            em.persist(book2);
        ...
        public void dbInit2() {
            Address address = new Address("부산", "25", "04231");
            Member member = CreateMember("UserB", address);
            em.persist(member);

            Book book1 = createBook("SPRING1 BOOK", 10000, 500);
            em.persist(book1);
